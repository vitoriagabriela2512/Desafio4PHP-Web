<?php
//Exercício 5 - Verificador de Idade para Votação
$anoNascimento = null;
$erro = null;
$resultado = null;
$anoAtual = date("Y");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validação
    if (!is_numeric($anoNascimento) || $anoNascimento < 1900 || $anoNascimento > $anoAtual) {
        $erro = "Ano de nascimento inválido.";
    } else {
        $idade = $anoAtual - $anoNascimento;
        
        // Verifica situação do voto
        ...
        $resultado = "Idade: $idade anos<br>Mensagem: $mensagem";
    }
}
?>
...
<head>
<meta charset="UTF-8">
<title>Ex 5. Verificador de Idade</title>
<style>
       body {
...
<p>Digite o ano de nascimento da pessoa.</p>
...
<form method="post" action="">
    <div>
        ...
        <input type="text" id="anoNascimento" name="anoNascimento" value="<?= htmlspecialchars($anoNascimento) ?>">
    </div>
    <div>
